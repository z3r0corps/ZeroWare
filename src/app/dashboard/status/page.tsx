          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center py-3 border-b border-dark-700">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-white font-semibold">CS2 Premium</span>
              </div>
            ...
            <div className="flex justify-between items-center py-3 border-b border-dark-700">
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                <span className="text-white font-semibold">Valorant Elite</span>
              </div>
              <span className="text-green-500 font-semibold">Active</span>
            </div>
            ...
            <div className="flex justify-between items-center py-3 border-b border-dark-700">
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                <span className="text-white font-semibold">Apex Legends Pro</span>
              </div>
              <span className="text-green-500 font-semibold">Active</span>
            </div>
        ...
        <div className="bg-dark-900 border border-dark-700 rounded-lg p-6">
          <div className="space-y-4">
            <div className="border-b border-dark-700 pb-4">
              <h3 className="text-white font-semibold">CS2 Premium v2.1.3</h3>
            ...
            <div className="border-b border-dark-700 pb-4">
              <h3 className="text-white font-semibold">Valorant Elite v1.8.2</h3>
