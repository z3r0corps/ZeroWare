  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-dark-900 border border-dark-700 rounded-lg p-6 hover:border-green-500 transition-colors cursor-pointer">
      ...
      <div className="bg-dark-900 border border-dark-700 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <button className="bg-indigo-500 hover:bg-indigo-600 text-white px-4 py-2 rounded-md transition-colors mt-2">
              Join Discord
            </button>
          </div>
          <div>
